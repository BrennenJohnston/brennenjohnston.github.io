---
title: Echo Show Input Guard
date: 2023-06-01
status: custom
categories: [communication]
summary: A custom touchscreen guard that turns a smart display into a dementia-friendly, voice-only communication device.
cover_image: /assets/images/projects/echo-input-guard/echo-guard-installed.jpg
cover_alt: "Amazon Echo Show on a wooden side table with a clear plexiglass guard fitted over its touchscreen, displaying a family photo."
gallery:
  - image: /assets/images/projects/echo-input-guard/echo-guard-fitting.jpg
    alt: "Echo Show standing on a workbench behind a sheet of polycarbonate with its protective paper backing, during fitting."
  - image: /assets/images/projects/echo-input-guard/echo-guard-masking.jpg
