...
If you print signs with it, feedback on braille readability from your printer is especially welcome — reach out through the [contact options]({{ '/about/' | relative_url }}).
