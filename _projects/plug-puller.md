---
title: Customizable Plug Puller v1
date: 2026-07-12
status: prototype
...
The model is currently at **version 0.8** and approaching a **v1.0 milestone**. The repo includes beginner guides (a five-minute measuring guide, quick-start walkthrough, and fit troubleshooting), ready-to-print Small / Medium / Large STLs, and a single-file build for web customizers.
